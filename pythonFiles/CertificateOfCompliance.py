...
def CompareChatgpt(Imagen1, Imagen2, contractNumber, typeofcontract, objectiveContract, startDate, endDate, periodValue, totalValue, nameComplete, idcard):
        ...
        if estado == "aprobado":
            ApiResponse(True, nameComplete, "OK","certificateOfCompliance", idUserContract, idDocumentManagement)
        else:
            razon = arguments.get("razon", "Documento alterado o inválido")
            ApiResponse(False, nameComplete, razon, "certificateOfCompliance", idUserContract, idDocumentManagement)
...
if resultado >= 0.90:
    ...
    ApiResponse(False,nameComplete,"Las imagenes son muy diferentes entre si","certificateOfCompliance",idUserContract,idDocumentManagement)