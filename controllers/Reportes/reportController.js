const Report = require('../../models/reportes/Report');
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        datosContratista: report.datosContratista,
        fechas: report.fechas,
        firmas: report.firmas,
        valores: report.valores,
...
// 6. Descargar reporte comparativo prellenado (sin ID)
