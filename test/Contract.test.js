...
describe('Crear toda la gestion de un contrato en la aplicacion de adcu en admin', function () {
    ...
    it('Toda la gestion de un contrato CRUD', async function () {
        ...
        await driver.findElement(until.elementsLocated(By.xpath('//*[@id="root"]/section/ol/li/div[2]/div[2]')));
    ...
    it('Elimiar contrato vinculado a un usuario')
